...
<body style="">
    ...
    <form action="/adMaestro" method="post">
        <span class="text-xs font-semibold	">Dni</span>
        <div style="border-color:grey;border-style: solid;border-width: 1px;">
            <input type="number" class="border-solid text-sm border-slate-800 w-full hover:bg-sky-50 text-slate-500" name="dni">
        </div>

        <span class="text-xs font-semibold	mt-4"> Correo Electronico</span>
        <div style="border-color:grey;border-style: solid;border-width: 1px;">
            <input type="email" class="border-solid	text-sm border-slate-800 w-full hover:bg-sky-50 text-slate-500" name='email'>
        </div>

        <span class="text-xs font-semibold	mt-4">Nombre (s) y apellido (s)</span>
        <div style="border-color:grey;border-style: solid;border-width: 1px;">
            <input type="text" class="border-solid	border-slate-800 w-full hover:bg-sky-50 text-slate-500" name='Nombre'>
        </div>

        <span class="text-xs font-semibold	mt-4">Direccion</span>
        <div style="border-color:grey;border-style: solid;border-width: 1px;">
            <input type="text" class="border-solid	border-slate-800 w-full hover:bg-sky-50 text-slate-500" name='Direccion'>
        </div>

        <div class="...">
            <input type="hidden" name="permiso" value="maestro" />
        </div>

        <span class="text-xs font-semibold	mt-4"> Fechas </span>
        <div style="border-color:grey;border-style: solid;border-width: 1px;">
            <input type="date" class="border-solid	border-slate-800 w-full hover:bg-sky-50 text-slate-500" name='fechas'>
        </div>
